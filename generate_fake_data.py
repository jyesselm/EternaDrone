...
def generate_bulge(size_x,size_y):
	ss = []
	seq = []
	sx = []
	sy = []
...
def generate_random_rna(size):
	...
	hairpin = generate_hairpin(random.randrange(3,7))
...
for i in range(1500):
	...
	sum.write(ss + " " + seq + " fake " + str(score) + "\n")
